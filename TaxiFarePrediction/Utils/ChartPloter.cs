...
namespace TaxiFarePrediction.Utils
{
    ...
    {
        public static void PlotRegressionChart(MLContext mlContext, string modelPath, string testDataSetPath, int numberOfRecordsToRead)
        {
            ...
            var predFunction = mlContext.Model.CreatePredictionEngine<TaxiTrip, PredictedTaxiFare>(trainedModel);
            ...
            using (var pl = new PLStream())
            {
                ...
                var testData = TaxiTripCsvReader.GetDataFromCsv(testDataSetPath).Take(totalNumber).ToList();
